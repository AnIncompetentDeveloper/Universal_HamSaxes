...
namespace UniversalHamSaxes.Items
{
    class NebulaHamSaxe : ModItem
    {
        public override void SetStaticDefaults() // ToolTip for the tool
        {
            ...
            Tooltip.SetDefault("You feel magic energy pouring out of this tool, almost like it's trying to tell you something... | Rightclick while holding tool to toggle Hammermode.");
