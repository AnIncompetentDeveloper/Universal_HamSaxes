...
namespace UniversalHamSaxes.Items
{
    class VortexHamSaxe : ModItem
    {
        public override void SetStaticDefaults() // ToolTip for the tool
        {
            ...
            Tooltip.SetDefault("Space and Time warp around this tool, almost as if it's existed for as long as the universe... perhaps even longer...! | Rightclick while holding tool to toggle Hammermode.");
