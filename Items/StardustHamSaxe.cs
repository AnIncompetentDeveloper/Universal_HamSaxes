...
namespace UniversalHamSaxes.Items
{
    class StardustHamSaxe : ModItem
    {
        public override void SetStaticDefaults() // ToolTip for the tool
        {
            ...
            Tooltip.SetDefault("The Dragons above made this over centuries, putting their very souls into this tool! | Rightclick while holding tool to toggle Hammermode.");
        ...
        public override void AddRecipes() // Recipie for the item
        {
            ...
            CreateRecipe()
                .AddIngredient(ItemID.LunarHamaxeStardust, 1)
