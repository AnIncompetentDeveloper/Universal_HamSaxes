...
{
  class AdamantiteMultiTool : ModItem
  {
    ...
    public override void AddRecipes()
    {
      CreateRecipe()
        ...
        .AddRecipeGroup("UniversalMultiTools:Adamantite Pickaxe or Drill")
        .AddRecipeGroup("UniversalMultiTools:Adamantite Axe or Saw")
