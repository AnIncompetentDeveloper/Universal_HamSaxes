        ...
        public override void AddRecipeGroups()
        {
           ...
           RecipeGroup.RegisterGroup("UniversalHamSaxes:Name of  group that will be called when calling for recipie group", (Name of Recipe Group));
            ...
            RecipeGroup OWCgroup = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " Orichalcum Axe or Saw", new int[]
            {
                ...
                /* 
                    The sky, dark and cloudy; on the verge of raining. Feels familiar, doesn't it?

                    Once clear and bright and full of hope and joy, now desolate and barren. Expectations ruined and plans let down. Everyone is disappointed. 

                    A family had planned to go on a picnic today, only to be stuck inside and look on with dispair with their plans ruined.
                    A group of friends were on their way to watch a baseball game only for them to arrive and the game be cancelled.

                    Everyone is disenchanted. 
                */
